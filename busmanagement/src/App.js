...
import Adlogout from './Components/Admin/Adlogout';
import Dclogout from './Components/DeptCordinator/Dclogout';
...
function App() {
  ...
  <Route path='/adlogout' element={<Adlogout/>}></Route>
  <Route path='/dclogout' element={<Dclogout/>}></Route>
    </Routes>
   </BrowserRouter>
    </div>
  );
