...
import '../Student/Sidenav.css' 
import { Link } from "react-router-dom";
import Logout from "../Student/Logout";
import Dclogout from "./Dclogout";

const li = [
  { link: "/maindept", text: "Student Applications" },
  { link: "/verifiedapplications", text: "Verified Applications" },
...
const Toolbar = (props) => (
  <header className="toolbar">
    <nav className="toolbar-nav">
      ...
      <div className="logo">
        <Link to="/">NEC PASS BUS MANAGEMENT SYSTEM</Link>
      </div>
      <div className="spacer"></div>
      <div>
        <ul>
          <li>
            <Link to="/deptprofile"> <i className="fas fa-user profile-icon"></i></Link>
          </li>
          <li><Dclogout></Dclogout></li>
        </ul>
      </div>
    </nav>
  </header>
