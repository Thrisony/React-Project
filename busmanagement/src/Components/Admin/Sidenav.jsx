...
const li = [
  { link: "/addbusdetails", text: "Add Bus details" },
  { link: "/mainadmin", text: "View Applications" },
  { link: "/managepass", text: "Manage Pass" },
  { link: "#", text: "Reports" },
...
const Toolbar = (props) => (
  <header className="toolbar">
    <nav className="toolbar-nav">
      ...
      <div className="logo">
        <Link to="/">NEC BUS PASS MANAGEMENT SYSTEM</Link>
      </div>
      <div className="spacer"></div>
      <div>
        <ul>
          <li>
            <Link to="/cardprofile"> <i className="fas fa-user profile-icon"></i></Link>
          </li>
          <li><Adlogout/></li>
        </ul>
      </div>
